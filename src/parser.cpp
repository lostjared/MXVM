...
namespace mxvm {
    ...
    bool Parser::generateDebugHTML(std::ostream &out, std::unique_ptr<Program> &program) {
        ...
        out << "<style>\n"
            ...
            "</style>\n</head>\n<body>\n";
        out << "<h1>MXVM Debug Information</h1>\n";

        // Variables Table
        out << "<section>\n<h2>Variables</h2>\n<table>\n";
        out << "<tr><th>Name</th><th>Type</th><th>Value</th></tr>\n";
        ...
        for (const auto& [label, addr] : program->labels) {
            out << "<tr><td>" << label << "</td><td class=\"addr\">" << addr << "</td></tr>\n";
        }
        out << "</table>\n</section>\n";
